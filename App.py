...
class Student:
    def __init__(self,root):
        ...
        Manage_Frame=Frame(self.root,bd=4,relief=RIDGE,bg="slateblue1")
        Manage_Frame.place(x=20,y=100,width=450,height=580)
        m_title=Label(Manage_Frame,text="Manage Students",bg="slateblue1",fg="white",font=('times new roman',30,"bold"))
        m_title.grid(row=0,columnspan=2,pady=20)

        lbl_roll=Label(Manage_Frame,text="Roll No",bg="slateblue1",fg="white",font=('times new roman',20,"bold"))
        lbl_roll.grid(row=1,column=0,pady=10,padx=20, sticky="w")

        txt_roll=Entry(Manage_Frame,textvariable=self.Roll_No_var,font=('times new roman',15,"bold"),bd=5,relief=GROOVE)
        txt_roll.grid(row=1,column=1,pady=10,padx=20, sticky="w")

        lbl_name = Label(Manage_Frame, text="Name", bg="slateblue1", fg="white",
        ...
        lbl_dept = Label(Manage_Frame, text="Department", bg="slateblue1", fg="white",
                         font=('times new roman', 20, "bold"))
        ...
        lbl_email = Label(Manage_Frame, text="Email", bg="slateblue1", fg="white",
                         font=('times new roman', 20, "bold"))
        ...
        lbl_Gender = Label(Manage_Frame, text="Gender", bg="slateblue1", fg="white",
                         font=('times new roman', 20, "bold"))
        ...
        lbl_contact = Label(Manage_Frame, text="Contact", bg="slateblue1", fg="white",
                         font=('times new roman', 20, "bold"))
        ...
        lbl_dob = Label(Manage_Frame, text="D.O.B", bg="slateblue1", fg="white",
                         font=('times new roman', 20, "bold"))
        ...
        #===Button===#
        btn_Frame = Frame(Manage_Frame, bd=4, relief=RIDGE, bg="slateblue1")
        btn_Frame.place(x=15, y=515, width=420)

        Addbtn=Button(btn_Frame,text="Add",width=10,command=self.add_students,bg="ivory4",fg="white").grid(row=0,column=0,padx=10,pady=10)
        updatebtn = Button(btn_Frame, text="Update", width=10,command=self.update_data,bg="ivory4",fg="white").grid(row=0, column=1, padx=10, pady=10)
        deletebtn = Button(btn_Frame, text="Delete", width=10,command=self.delete_data,bg="ivory4",fg="white").grid(row=0, column=2, padx=10, pady=10)
        Clearbtn = Button(btn_Frame, text="Clear", width=10,command=self.clear,bg="ivory4",fg="white").grid(row=0, column=3, padx=10, pady=10)
        ...
        Detail_Frame = Frame(self.root, bd=4, relief=RIDGE, bg="slateblue1")
        Detail_Frame.place(x=500, y=100, width=800, height=580)

        lbl_Search= Label(Detail_Frame, text="Search By", bg="slateblue1", fg="white",
                        font=('times new roman', 20, "bold"))
        ...
        Table_Frame= Frame(Detail_Frame, bd=4, relief=RIDGE, bg="slateblue1")
